...
use crate::openapi::parse::models::{ContentMediaType, ParamStyle};
...
fn apply_path_params(path_template: &str, params: &[crate::openapi::parse::RouteParam]) -> String {
...
fn serialize_path_param(param: &crate::openapi::parse::RouteParam) -> String {
...
fn build_querystring_value(param: &crate::openapi::parse::RouteParam) -> String {
    if let Some(example) = &param.example {
        if example.is_serialized() {
            return example_value_to_string(example);
        }
    ...
    if matches!(
        ...
        None | Some(crate::openapi::parse::ContentMediaType::FormUrlEncoded)
    ) {
        return serialize_form_urlencoded_querystring(&value);
    }

    match param.content_media_type {
        Some(crate::openapi::parse::ContentMediaType::Json) => {
            let serialized = serde_json::to_string(&value).unwrap_or_else(|_| value.to_string());
            encode_rfc3986(&serialized, false)
        }
        Some(crate::openapi::parse::ContentMediaType::Other(_)) | None => {
            let raw = match value {
        ...
        Some(crate::openapi::parse::ContentMediaType::FormUrlEncoded) => {
...
fn example_value_to_string(example: &crate::openapi::parse::ExampleValue) -> String {
...
fn serialize_query_params(params: &[crate::openapi::parse::RouteParam]) -> String {
...
fn serialize_cookie_params(params: &[crate::openapi::parse::RouteParam]) -> String {
    let mut pairs = Vec::new();
...
fn serialize_header_param(param: &crate::openapi::parse::RouteParam) -> String {
    if let Some(example) = &param.example {
        if example.is_serialized() {
            return example_value_to_string(example);
        }
...
fn serialize_cookie_param(param: &crate::openapi::parse::RouteParam) -> Vec<String> {
    if let Some(example) = &param.example {
        if example.is_serialized() {
...
fn serialize_query_param(param: &crate::openapi::parse::RouteParam) -> Vec<String> {
    if let Some(example) = &param.example {
        if example.is_serialized() {
            return vec![example_value_to_string(example)];
        }
...
mod tests {
    use super::*;
    use crate::openapi::parse::models::RouteKind;
    use crate::openapi::parse::{BodyFormat, ParamSource, ParsedRoute, RequestBodyDefinition};
    ...
    fn test_generate_contract_test_structure() {
        let routes = vec![ParsedRoute {
            ...
            operation_id: None,
            params: vec![crate::openapi::parse::RouteParam {
                name: "id".into(),
                description: None,
    ...
    fn test_generate_with_query_params() {
        let routes = vec![ParsedRoute {
            ...
            operation_id: None,
            params: vec![
                crate::openapi::parse::RouteParam {
                    name: "q".into(),
                    description: None,
    ...
    fn test_path_param_matrix_style() {
        let param = crate::openapi::parse::RouteParam {
            name: "color".into(),
            description: None,
            source: ParamSource::Path,
            ty: "String".into(),
    ...
    fn test_query_param_uses_serialized_example_directly() {
        let param = crate::openapi::parse::RouteParam {
            ...
            example: Some(crate::openapi::parse::ExampleValue::serialized(
                serde_json::json!("color=blue%20black"),
            )),
            raw_schema: None,
            extensions: BTreeMap::new(),
        };
    ...
    fn test_querystring_json_encodes_non_string() {
        let param = crate::openapi::parse::RouteParam {
            ...
            source: ParamSource::QueryString,
            ty: "serde_json::Value".into(),
            content_media_type: Some(crate::openapi::parse::ContentMediaType::Json),
            style: None,
            explode: false,
            deprecated: false,
            allow_empty_value: false,
    ...
    fn test_querystring_form_urlencoded_encodes_spaces() {
        let param = crate::openapi::parse::RouteParam {
            ...
            source: ParamSource::QueryString,
            ty: "serde_json::Value".into(),
            content_media_type: Some(crate::openapi::parse::ContentMediaType::FormUrlEncoded),
            style: None,
            explode: false,
            deprecated: false,
            allow_empty_value: false,
