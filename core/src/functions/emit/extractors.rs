...
use crate::functions::emit::parsing::{
    extract_path_vars, find_param_type, to_pascal_case, to_snake_case,
};
use crate::openapi::parse::{BodyFormat, ParamSource, ParsedRoute};
...
mod tests {
    ...
    use crate::functions::emit::builder::update_handler_module;
    use crate::openapi::parse::models::{
        ContentMediaType, ResponseHeader, RouteKind, SecurityRequirement, SecurityRequirementGroup,
    };
    use crate::openapi::parse::{BodyFormat, RequestBodyDefinition, RouteParam};
