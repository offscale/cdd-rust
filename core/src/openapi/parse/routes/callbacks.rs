...
use crate::openapi::parse::models::{ParamSource, ParsedCallback, RouteParam, RuntimeExpression};
use crate::openapi::parse::ref_utils::extract_component_name;
use crate::openapi::parse::registry::DocumentRegistry;
use crate::openapi::parse::resolver::body::extract_request_body_type_with_registry;
...
use crate::openapi::parse::routes::builder::parse_security_requirements;
use crate::openapi::parse::routes::shims::{ShimComponents, ShimOperation, ShimPathItem};
...
mod tests {
    use super::*;
    use crate::openapi::parse::models::BodyFormat;
    use crate::openapi::parse::resolver::params::SchemaOrBool;
    use crate::openapi::parse::resolver::ShimParameter;
    use crate::openapi::parse::routes::shims::{ShimComponents, ShimOperation, ShimPathItem};
    use serde_json::json;
    ...
    fn test_extract_callback_operations_collects_details() {
        ...
        op.request_body = Some(RefOr::T(
            crate::openapi::parse::routes::shims::ShimRequestBody::from(body),
        ));
        op.responses = crate::openapi::parse::routes::shims::ShimResponses::from(responses);
    ...
    fn test_extract_callback_security_inherits_global() {
        let mut path_item = empty_path_item();
        let mut op = empty_operation();
        op.responses = crate::openapi::parse::routes::shims::ShimResponses::from(Responses::new());
