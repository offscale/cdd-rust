...
use crate::classes::parse::{
    ParsedEnum, ParsedExternalDocs, ParsedModel, ParsedStruct, ParsedVariant,
};
use crate::error::{AppError, AppResult};
use crate::openapi::parse::normalization::{
...
use crate::openapi::parse::routes::shims::{ShimExternalDocs, ShimOpenApi};
use crate::openapi::parse::schemas::enums::parse_variants;
use crate::openapi::parse::schemas::refs::{
...
use crate::openapi::parse::schemas::structs::flatten_schema_fields;
use crate::openapi::parse::validation::validate_component_keys;
...
fn apply_field_external_docs(
    fields: &mut [crate::classes::parse::ParsedField],
